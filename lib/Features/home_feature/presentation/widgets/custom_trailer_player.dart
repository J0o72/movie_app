...
import 'package:movie_app/Features/home_feature/presentation/widgets/Skeletonizer/trailer_player_skeletonizer.dart';
    ...
    return BlocBuilder<TraillerCubit, TraillerState>(
      builder: (context, state) {
        if (state is TraillerSuccess) {
          ...
          return const TrailerPlayerSkeletonizer();
        }
      },
    );
  }
